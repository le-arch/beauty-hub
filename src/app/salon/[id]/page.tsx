...
export default function PublicSalonProfilePage() {
  ...
  const handleBookNow = () => {
    // For a public page, this should prompt login/signup
    router.push(`/login?redirect=/salon/${salonId}`);
  };
  ...
  return (
    <>
    <Header />
    <main className="bg-gradient-beauty-secondary pt-16">
