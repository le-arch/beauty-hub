        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="border-purple-100 hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-warmgray-600 mb-1">Profile Views</p>
                  <p className="text-2xl font-semibold text-warmgray-900">{mockAnalytics.profileViews}</p>
          ...
          <Card className="border-purple-100 hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-warmgray-600 mb-1">New Inquiries</p>
                  <p className="text-2xl font-semibold text-warmgray-900">{mockAnalytics.monthlyInquiries}</p>
                  <p className="text-xs text-green-600 mt-1 flex items-center">
                    <TrendingUp className="h-3 w-3 mr-1" />
                    +8% from last month
                  </p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-warmgray-900">{mockAnalytics.averageRating}</p>
                  <p className="text-xs text-warmgray-500 mt-1">{mockAnalytics.totalReviews} reviews</p>
                </div>
          ...
          <Card className="border-purple-100 hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-warmgray-600 mb-1">This Month</p>
                  <p className="text-2xl font-semibold text-warmgray-900">{mockAnalytics.monthlyRevenue}</p>
                  <p className="text-xs text-green-600 mt-1 flex items-center">
                    <TrendingUp className="h-3 w-3 mr-1" />
                    +15% from last month
                  </p>
